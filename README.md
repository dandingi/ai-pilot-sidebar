...
固定在 Chrome 右侧的轻量多 AI 侧边栏工具。支持 ChatGPT、Grok、Gemini、豆包、Kimi、Claude、DeepSeek、Copilot 和自定义 AI。
...
- 支持 ChatGPT、Grok、Gemini、豆包、Kimi、Claude、DeepSeek、Copilot。
- 支持添加自定义 AI 网站。
- 支持设置默认启动 AI。
- 支持记住上次使用的 AI。
- 支持显示、隐藏和调整 AI 顺序。
...
```text
使用你自己的官方 AI 账号，不代理模型，不保存对话，不保存账号密码。
```
